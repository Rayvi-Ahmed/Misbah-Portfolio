...
const ProjectData = ({ project }) => {
    ...
    return (
        <div className="card card-side border-2 border-white/30 bg-black/20 rounded-none backdrop-blur-2xl  text-white/50 max-h-[450px]">
            ...
            <div className="card-body p-3">
                ...
                <div className='flex flex-1 items-center justify-center gap-3'>
                    <a href={liveLink}><button className='btn btn-sm rounded-3xl'>Live Link</button></a>
                    <a href={gitClient}><button className='btn btn-sm rounded-3xl'>Client Side</button></a>
                    <a href={gitServer}><button className='btn btn-sm rounded-3xl'>Server Side</button></a>
                </div>
            </div>
        </div>
    );
